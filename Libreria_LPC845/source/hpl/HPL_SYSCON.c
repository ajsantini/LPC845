...
{
	if(clock_selection != SYSTEM_CLOCK_SEL_PLL)
	{
		switch(SYSCON->MAINCLKSEL.SEL)
		{
		case SYSTEM_CLOCK_SEL_EXT_CLK:
		{
		...
		case SYSTEM_CLOCK_SEL_WATCHDOG:
		{
...
void SYSCON_set_crystal_clock(uint32_t crystal_frequency)
{
	...
	xtal_pin_config.mode = PULL_NONE;
	...
	xtal_pin_config.sample_mode = SAMPLE_MODE_BYPASS;
...
uint32_t SYSCON_get_peripheral_clock(peripheral_selection_en peripheral)
{
	...
	{
	case PERIPHERAL_CLOCK_SELECTION_MAIN:
	{
	...
	case PERIPHERAL_CLOCK_SELECTION_FRO:
	{
		return current_fro_clock;
	...
	case PERIPHERAL_CLOCK_SELECTION_FRO_DIV:
	{
	...
	case PERIPHERAL_CLOCK_SELECTION_NONE:
	{
		return 0;
	...
	case PERIPHERAL_CLOCK_SELECTION_FRG0:
	{
	...
	case PERIPHERAL_CLOCK_SELECTION_FRG1:
	{
...
void SYSCON_set_frg_config(uint8_t frg_selection, frg_clock_selection_en clock_source, uint8_t mul, uint16_t div)
{
	...
	case FRG_CLOCK_SELECTION_MAIN_CLOCK:
	{
	...
	case FRG_CLOCK_SELECTION_SYS_PLL:
	{
