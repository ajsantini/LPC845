\hypertarget{HAL__WKT_8h}{}\doxysection{Referencia del Archivo includes/hal/\+H\+A\+L\+\_\+\+W\+KT.h}
\label{HAL__WKT_8h}\index{includes/hal/HAL\_WKT.h@{includes/hal/HAL\_WKT.h}}
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{HAL__WKT_8h_aeb732cadeaab8af681865670e8beab43}{hal\+\_\+wkt\+\_\+init}} (hal\+\_\+wkt\+\_\+clock\+\_\+source\+\_\+en clock\+\_\+sel, uint32\+\_\+t ext\+\_\+clock\+\_\+value, void($\ast$callback)(void))
...
\item 
void \mbox{\hyperlink{HAL__WKT_8h_a83ba94b350eac43185f64f92e6a2ceab}{hal\+\_\+wkt\+\_\+register\+\_\+callback}} (void($\ast$new\+\_\+callback)(void))
...
\index{HAL\_WKT.h@{HAL\_WKT.h}!hal\_wkt\_init@{hal\_wkt\_init}}
\index{hal\_wkt\_init@{hal\_wkt\_init}!HAL\_WKT.h@{HAL\_WKT.h}}
\doxysubsubsection{\texorpdfstring{hal\_wkt\_init()}{hal\_wkt\_init()}}
...
\mbox{\texttt{ in}}  & {\em clock\+\_\+sel} & Seleccion de clock deseada para el W\+KT \\
\hline
\mbox{\texttt{ in}}  & {\em ext\+\_\+clock\+\_\+value} & Valor de clock externo (si la seleccion es interna, no importa este parametro) \\
\hline
\mbox{\texttt{ in}}  & {\em callback} & Callback a ejecutar en la interrupcion del W\+KT \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{HAL__WKT_8h_a83ba94b350eac43185f64f92e6a2ceab}\label{HAL__WKT_8h_a83ba94b350eac43185f64f92e6a2ceab}} 
\index{HAL\_WKT.h@{HAL\_WKT.h}!hal\_wkt\_register\_callback@{hal\_wkt\_register\_callback}}
\index{hal\_wkt\_register\_callback@{hal\_wkt\_register\_callback}!HAL\_WKT.h@{HAL\_WKT.h}}
\doxysubsubsection{\texorpdfstring{hal\_wkt\_register\_callback()}{hal\_wkt\_register\_callback()}}
...
\begin{DoxyParams}[1]{Parámetros}
\mbox{\texttt{ in}}  & {\em new\+\_\+callback} & Nuevo callback para la interrupcion del W\+KT \\
\hline
\end{DoxyParams}
